...
pub fn get_text(language: Language) -> UiText {
    match language {
        Language::English => UiText {
            ...
            minutes: "{:.1} minutes",
            seconds: "{}.{:03} seconds",
            aco_faster: "ACO is approximately {:.1}x faster than standard approach",
        ...
        Language::Portuguese => UiText {
            ...
            minutes: "{:.1} minutos",
            seconds: "{}.{:03} segundos",
            aco_faster: "ACO é aproximadamente {:.1}x mais rápido que a abordagem padrão",
